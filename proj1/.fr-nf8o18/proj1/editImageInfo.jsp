...
/***********************************************************************************/
	 ...
	 try{
	 	...
	 	rset = stmt1.executeQuery(updateImage); 
	 	 ...
	 	 try{
	 	stmt1 = conn.createStatement();
	 	rset = stmt1.executeQuery("	UPDATE images SET 	owner_name = '"+owner_name+"', permitted = "+permitted+", subject = '"+subject+"', place = '"+place+"', timing =date '"+timing+"', description = '"+description +"' WHERE owner_name = 'admin'"); 
